...
#define MAX_NUMBER 128  // 一画面における、数字の最大数

#define SCORE_POS D3DXVECTOR3(300.0f, 42.0f, 0.0f)       // スコアの位置
#define SCORE_SIZE D3DXVECTOR3(200.0f, 40.0f, 0.0f)      // スコアの大きさ

#define SCORE_DEFEAT_WITH_WEAK_COLOR D3DXCOLOR(1.0f, 0.0f, 0.0f, 1.0f)      // 弱点で倒した時の色
#define SCORE_DEFEAT_ONE_SHOT_COLOR D3DXCOLOR(0.929f, 0.427f, 0.0f, 1.0f)   // 一発で倒した時の色
#define SCORE_DEFEAT_HALF_COLOR D3DXCOLOR(0.0f, 0.525f, 1.0f, 1.0f)         // 半減で倒した時の色

#define SCORE_DISP_UP D3DXVECTOR3(00.0f, -25.0f, 0.0f)       // スコアの位置を上げる
