...
// ランキングのコンストラクタ
//========================================
CRanking::CRanking() :CScene(OBJTYPE::OBJTYPE_RANKING)
{
    m_nCntTime = 0;
...
void CRanking::ReadScore(void)
{
    ...
    {
        // デュオ
        pFile = fopen("data/TXT/score2.txt", "r");
    }
    ...
    {
        // デュオ
        pFile = fopen("data/TXT/score2.txt", "w");
    }
