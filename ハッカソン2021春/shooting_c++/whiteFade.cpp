    ...
    case CWhiteFade::TYPE_A:
        ...
        if (m_nTimer > 0)
        {
            ...
            if (m_nTimer <= 0)
            {
                ...
                // ステージをベータに
                CGame::SetStage(CManager::STAGE_B);
            }
        }
    ...
    case CWhiteFade::TYPE_B:
        ...
        if (m_nTimer > 0)
        {
            ...
            if (m_nTimer <= 0)
            {
                ...
                // ステージをガンマに
                CGame::SetStage(CManager::STAGE_C);
            }
        }
...
HRESULT CWhiteFade::Load(void)
{
    ...
    //テクスチャの読み込み
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/whiteFade000.png", &m_apTexture[CWhiteFade::TYPE_A]);
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/whiteFade000.png", &m_apTexture[CWhiteFade::TYPE_B]);
