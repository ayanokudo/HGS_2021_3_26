...
HRESULT CUI::Load(void)
{
    ...
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/ui006.png", &m_apTexture[CUI::TYPE_ZONE_A]);	        // ゾーンα
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/ui013.png", &m_apTexture[CUI::TYPE_ZONE_B]);	        // ゾーンβ
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/ui014.png", &m_apTexture[CUI::TYPE_ZONE_C]);	        // ゾーンγ
    ...
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/ui012.png", &m_apTexture[CUI::TYPE_CLEAR_A]);	        // αクリア
    ...
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/ui017.png", &m_apTexture[CUI::TYPE_CLEAR_B]);	        // βクリア
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/ui018.png", &m_apTexture[CUI::TYPE_CLEAR_C]);	        // γクリア
