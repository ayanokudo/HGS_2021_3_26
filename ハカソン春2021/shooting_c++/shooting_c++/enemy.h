...
// 爽太調整
//==============================================
#define SOUTA_ANGLE 48.25f
#define ROT_SPEED D3DXToRadian(2.5f)        // リンゴの回転速度
#define GET_SCORE 100   // スコア
//==============================================

#define MOVE_ANGLE_LEFT D3DXVECTOR3(cosf(D3DXToRadian(180.0f + SOUTA_ANGLE)), -sinf(D3DXToRadian(180.0f + SOUTA_ANGLE)), 0.0f)
#define MOVE_ANGLE_RIGHT D3DXVECTOR3(cosf(D3DXToRadian(360.0f - SOUTA_ANGLE)), -sinf(D3DXToRadian(360.0f - SOUTA_ANGLE)), 0.0f)

#define MOVE_STRAIGHT D3DXVECTOR3(cosf(D3DXToRadian(270.0f)), -sinf(D3DXToRadian(270.0f)), 0.0f)
...
// ハエの各設定
#define ENEMY_FLY_SIZE D3DXVECTOR3(90.0f, 90.0f, 0.0f)
#define ENEMY_FLY_COLLISION_SIZE D3DXVECTOR3(65.0f, 65.0f, 0.0f)
#define ENEMY_FLY_LIFE 70
#define ENEMY_FLY_SPEED 6.0f
#define ENEMY_FLY_SCORE 500

// 骸骨の各設定
#define ENEMY_SKELETON_SIZE D3DXVECTOR3(70.0f, 70.0f, 0.0f)
...
public:
    ...
    static CEnemy *Create(D3DXVECTOR3 pos, D3DXVECTOR3 size, float fSpeed, bool bMoveUp, TYPE type);
    ...
    D3DXVECTOR3 move(D3DXVECTOR3 pos, D3DXVECTOR3 size);
    TYPE GetType(void) { return m_type; }
    void SetDeath(void) { m_bUse = false; }
