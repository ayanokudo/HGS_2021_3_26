...
CBg::CBg() :CScene(OBJTYPE::OBJTYPE_BG)
{
    ...
    m_nScrollSpeed = SCROLL_FIRST_SPEED;
}
...
HRESULT CBg::Load(void)
{
    ...
    // テクスチャの読み込み
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/bg_000.png", &m_apTexture[CBg::TYPE_SKY]);
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/bg_001.png", &m_apTexture[CBg::TYPE_MOUNTAIN]);
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/bg_002.png", &m_apTexture[CBg::TYPE_WOODS]);
...
HRESULT CBg::Init(D3DXVECTOR3 pos, D3DXVECTOR3 size)
{
    ...
    case SET_A:
        ...
        m_apScene2D[CBg::TYPE_SKY]->CScene2D::Init(D3DXVECTOR3(SCREEN_WIDTH / 2, 120.0f, 0.0f), D3DXVECTOR3(1280.0f, 240.0f, 0.0f));
        m_apScene2D[CBg::TYPE_MOUNTAIN] = new CScene2D;
        m_apScene2D[CBg::TYPE_MOUNTAIN]->CScene2D::Init(D3DXVECTOR3(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, 0.0f), D3DXVECTOR3(1280.0f, 240.0f, 0.0f));
        m_apScene2D[CBg::TYPE_WOODS] = new CScene2D;
        m_apScene2D[CBg::TYPE_WOODS]->CScene2D::Init(D3DXVECTOR3(SCREEN_WIDTH / 2, SCREEN_HEIGHT - 120.0f, 0.0f), D3DXVECTOR3(1280.0f, 240.0f, 0.0f));
        m_apScene2D[CBg::TYPE_FOREST] = new CScene2D;
        m_apScene2D[CBg::TYPE_FOREST]->CScene2D::Init(DEFAULT_VECTOR, DEFAULT_VECTOR);
...
void CBg::direct(void)
{
    ...
    m_apScene2D[CBg::TYPE_SKY]->SetFlowingAnimation(1, m_nScrollSpeed, bLeft, CScene2D::DIRECT_HORIZON);
    ...
    m_apScene2D[CBg::TYPE_MOUNTAIN]->SetFlowingAnimation(1, m_nScrollSpeed, bLeft, CScene2D::DIRECT_HORIZON);
    ...
    m_apScene2D[CBg::TYPE_WOODS]->SetFlowingAnimation(1, m_nScrollSpeed, bLeft, CScene2D::DIRECT_HORIZON);
}
