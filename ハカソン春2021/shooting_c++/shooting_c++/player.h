...
// マクロ定義
//================================================
#define PLAYER_START_POS_X (SCREEN_WIDTH / 2)                                           // 自機の開始X座標
#define PLAYER_START_POS_Y (670.0f)                              // 自機の開始Y座標
#define PLAYER_POS D3DXVECTOR3(PLAYER_START_POS_X, PLAYER_START_POS_Y, 0.0f)// 自機の位置
#define PLAYER_POS2 D3DXVECTOR3(320.0f, PLAYER_START_POS_Y, 0.0f)// 自機の位置2
#define PLAYER_POS3 D3DXVECTOR3(960.0f, PLAYER_START_POS_Y, 0.0f)// 自機の位置3
#define PLAYER_SIZE D3DXVECTOR3(100.0f, 100.0f, 0.0f)		                // 自機の描画サイズ
#define PLAYER_COLLISION_SIZE D3DXVECTOR3(80.0f, 80.0f, 0.0f)	            // 自機の衝突サイズ
