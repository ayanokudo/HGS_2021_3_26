...
#define STOCK_UI_POS (D3DXVECTOR3(100.0f,55.0f,0.0f))     // ストックの位置
...
#define STOCK_BAR_UI_POS (D3DXVECTOR3(120.0f,65.0f,0.0f))                    // ストックのバーの位置
#define STOCK_BAR_UI_SIZE_X (100.0f)                                           // ストックバーの横サイズ
#define STOCK_BAR_UI_SIZE (D3DXVECTOR3(STOCK_BAR_UI_SIZE_X,30.0f,0.0f))       // ストックバーのサイズ
